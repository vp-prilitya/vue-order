        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                    <div class="form-group">
                        ...
                        <input v-model="id" type="text" class="form-control" v-bind:class="{ 'is-invalid' : error.error }" disabled>
...
export default {
    ...
    methods: {
        getOrderById(){
            // this.$store.dispatch('order/getById', this.$route.params.orderId);
            OrderSevice.getByid(this.$route.params.orderId)
                .then(
                    data => {
                        this.data = data.data
                    }
        ...
        create(data){
            console.log(data)
            this.$store.dispatch('order/updateOrder',{id :this.$route.params.orderId, data: data});
        },
